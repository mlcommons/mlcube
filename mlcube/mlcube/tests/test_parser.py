...
class TestParser(TestCase):
    ...
    def test_parse_extra_args_parsed_docker(self) -> None:
        mlcube_args, task_args = CliParser.parse_extra_arg(
            ...
            parsed_args={
                "platform": "docker",
                "network": "NETWORK_1", "security": "SECURITY_1", "gpus": "GPUS_1", "memory": "MEMORY_1", "cpu": "CPU_1", "mount": "MOUNT_1"
            }
        )
        self._check_cli_args(
            actual_mlcube_args=mlcube_args,
    ...
    def test_parse_extra_args_parsed_singularity(self) -> None:
        mlcube_args, task_args = CliParser.parse_extra_arg(
            ...
            parsed_args={
                ...
                "network": "NETWORK_2", "security": "SECURITY_2", "gpus": "GPUS_2", "memory": "MEMORY_2", "cpu": "CPU_2", "mount": "MOUNT_2"
            }
        )
        self._check_cli_args(
            actual_mlcube_args=mlcube_args,
