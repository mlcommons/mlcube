...
def main(unused_argv):
  ...
  vocab_file = os.path.join(FLAGS.data_dir, constants.VOCAB_FILE)
  subtokenizer = tokenizer.Subtokenizer.init_from_files(
      vocab_file, train_files_flat, constants.TARGET_VOCAB_SIZE, constants.TARGET_THRESHOLD,
      min_count=None if FLAGS.search else constants.TRAIN_DATA_MIN_COUNT)
